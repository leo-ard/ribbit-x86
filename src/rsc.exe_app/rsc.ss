...
(define Main-decodeAndRun (lambda (ext-0) (let ((act-24 ((csegen-44) ext-0))) (let ((act-25 (lambda (eta-0) (lambda (eta-1) (lambda (eta-2) (lambda (eta-3) (Main-MakeRib act-24 eta-0 eta-1 eta-2 eta-3))))))) (let ((act-26 (((((act-25 (vector 0 0)) (vector 0 0)) (vector 0 5)) (csegen-43)) ext-0))) (let ((act-27 (((((act-25 (vector 0 0)) (vector 0 0)) (vector 0 5)) (csegen-43)) ext-0))) (let ((act-28 (((((act-25 (vector 0 0)) (vector 0 0)) (vector 0 5)) (csegen-43)) ext-0))) (let ((act-29 ((csegen-44) ext-0))) (let ((u--state (vector act-26 act-27 act-28 act-29 act-24 act-28))) (let ((act-30 ((Main-getInt act-29 (csegen-43) 0) ext-0))) (let ((act-31 ((Main-buildSymtbl u--state act-30 (let ((e-5 (vector-ref u--state 5))) e-5) (csegen-43)) ext-0))) (let ((act-32 (vector (let ((e-0 (vector-ref u--state 0))) e-0) (let ((e-1 (vector-ref u--state 1))) e-1) (let ((e-2 (vector-ref u--state 2))) e-2) (let ((e-3 (vector-ref u--state 3))) e-3) (let ((e-4 (vector-ref u--state 4))) e-4) act-31))) (let ((act-33 ((Main-decodeStack act-32 (vector 0 0) (csegen-43)) ext-0))) (let ((act-34 ((Main-setupGlobal act-32 (csegen-43)) ext-0))) (let ((act-35 ((Main-rCar act-33 (csegen-43)) ext-0))) (let ((act-36 ((Main-rCgr act-35 (csegen-43)) ext-0))) (let ((act-37 (((((act-25 (vector 0 5)) (vector 0 0)) (vector 0 0)) (csegen-43)) ext-0))) (let ((act-38 (((((act-25 (vector 0 0)) (vector 0 0)) act-37) (csegen-43)) ext-0))) ((Main-run act-32 act-36 act-38 0 (csegen-43)) ext-0)))))))))))))))))))
